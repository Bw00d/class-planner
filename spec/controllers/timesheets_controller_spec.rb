...
RSpec.describe TimesheetsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested timesheet as @timesheet" do
      timesheet = Timesheet.create! valid_attributes
      get :show, params: {id: timesheet.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested timesheet as @timesheet" do
      timesheet = Timesheet.create! valid_attributes
      get :edit, params: {id: timesheet.to_param}, session: valid_session
      expect(assigns(:timesheet)).to eq(timesheet)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Timesheet" do
        expect {
          post :create, params: {timesheet: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved timesheet as @timesheet" do
        post :create, params: {timesheet: invalid_attributes}, session: valid_session
        expect(assigns(:timesheet)).to be_a_new(Timesheet)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested timesheet" do
        timesheet = Timesheet.create! valid_attributes
        put :update, params: {id: timesheet.to_param, timesheet: new_attributes}, session: valid_session
        timesheet.reload
      ...
      it "assigns the requested timesheet as @timesheet" do
        timesheet = Timesheet.create! valid_attributes
        put :update, params: {id: timesheet.to_param, timesheet: valid_attributes}, session: valid_session
        expect(assigns(:timesheet)).to eq(timesheet)
      end
    ...
    context "with invalid params" do
      it "assigns the timesheet as @timesheet" do
        timesheet = Timesheet.create! valid_attributes
        put :update, params: {id: timesheet.to_param, timesheet: invalid_attributes}, session: valid_session
        expect(assigns(:timesheet)).to eq(timesheet)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested timesheet" do
      timesheet = Timesheet.create! valid_attributes
      expect {
        delete :destroy, params: {id: timesheet.to_param}, session: valid_session
      }.to change(Timesheet, :count).by(-1)
    end
